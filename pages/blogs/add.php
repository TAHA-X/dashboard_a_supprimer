 ...
 if(!isset($_SESSION["login"])){
  ...
  if(isset($_POST["add"])){
       ...
       if($title!="" && $contenu!="" && $presentation!="" && $img!=""){
          $stmt = $conn->prepare("INSERT into blogs(title,presentation,img,contenu,date) values(:title,:presentation,:img,:contenu,:date)");
          ...
          $success = "blog added with success";
       }
       else{
                      ...
                      <form enctype="multipart/form-data" class="pt-2" method="post">
                           ...
                           <div class="d-flex m-2 gap-2 w-100">
                               <div class="w-100">
                                     ...
                                     <input value="" type="file" name="img" class="form-control"/>
                               </div>
                           </div>
