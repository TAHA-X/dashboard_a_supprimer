            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between">
                      ...
                      <a class="m-2" href="add.php">ajouter un blog</a>
                    </div>
                              ...
                              foreach($blogs as $blog){
                                ?>
                                    <tr>
                                        ...
                                        <td><img style="width:150px; height:120px;" src="<?php echo "imgs/".$blog["img"]; ?>"/></td>
                                        <td><?php echo $blog["title"]; ?></td>
                                        <td><?php echo $blog["date"]; ?></td>
                                        <td>
                                            <a href="edit.php?num_blog=<?php echo $blog['id']; ?>" class="btn btn-success">view</a>
                                            <a onclick="return confirm('voulez vous vraiment supprimer cette blog ?')" class="btn btn-danger" href="delete.php?num_blog=<?php echo $blog['id']; ?>">delete</a>
                                        </td>
                                    </tr>
                                <?php
                              }
